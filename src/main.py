...
def ecrire_fichier():
    ...
    print("liste here", planning.liste_heure)
    print("liste cle", cle2)
    dict_heure = {}
    Nb = 0
    for i in cle2:
        dict_heure[i] = Nb+2
...
cheval_listbox = tk.Listbox(window, height=48)
